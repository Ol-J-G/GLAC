...
/**
 * Test, that digital clock portrait layout with:
 * - ClockCharType.SEVEN_SEGMENT clockChars and
 * - CHAR dividers
 * must fall back to LINE dividers (CHAR dividers in 7-seg aren't displayable)
 *
 ...
 */
class DigitalClockPortraitFormattedTimeTestCharDividerSevenSegment {
