...
fun MinutesTensColorSelector(
    ...
    ColorSelector(
        title = stringResource(id = R.string.minutes_shortened) + " " + stringResource(R.string.tens),
        color = clockTheme.clockPartsColors.minutes.tens
